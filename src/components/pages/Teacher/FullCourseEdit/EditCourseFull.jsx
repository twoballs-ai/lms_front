                        ...
                        <div className="leftsidebar ps-2" >
                            ...
                            {chapterData.map((tech, index) =>
                                <>
                                    ...
                                    {tech.chapter_modules.map((modules, index) =>
                                        <ul class="nav flex-column">
                                            <li class="nav-item ">
                                                ...
                                                <Link className="nav-link text-light" to={'/edit-course-full/edit-module/'+ course_id + '/'+ modules.id}>{modules.title}</Link>
                                            </li>
                                    ...
                                    <Button className="ms-5" as={Link} to={'/edit-course-full/add-module/' + course_id + '/' + tech.id} variant="success">+ модуль</Button>{' '}
                                </>
                            )}
                            <hr />
                            <Button as={Link} to={'/edit-course-full/add-chapter-full/' + course_id} variant="outline-success">добавить новую главу</Button>{' '}
