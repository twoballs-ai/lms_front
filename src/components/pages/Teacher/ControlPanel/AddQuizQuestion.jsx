  ...
  const formSubmit=(e)=>{
    ...
    return(
      ...
      <Form.Group className="mb-3" controlId="formBasicCategory">
        ...
        <Form.Control name="answer1"  type="text" placeholder="категория" onChange={handleChange} />
      </Form.Group>
      
      <Form.Group className="mb-3" controlId="formBasicCategory">
        <Form.Label>Ответ 2</Form.Label>
        <Form.Control name="answer2"  type="text" placeholder="категория" onChange={handleChange} />
      </Form.Group>
      
      <Form.Group className="mb-3" controlId="formBasicCategory">
        <Form.Label>Ответ 3</Form.Label>
        <Form.Control name="answer3"  type="text" placeholder="категория" onChange={handleChange} />
      </Form.Group>
      
      <Form.Group className="mb-3" controlId="formBasicCategory">
        <Form.Label>Ответ 4</Form.Label>
        <Form.Control name="answer4"  type="text" placeholder="категория" onChange={handleChange} />
      </Form.Group>
      <Form.Group className="mb-3" controlId="formBasicCategory">
        <Form.Label>Правильный ответ</Form.Label>
        <Form.Control name="true_answer"  type="text" placeholder="категория" onChange={handleChange} />
      </Form.Group>
