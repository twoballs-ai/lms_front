  ...
  const formSubmit=(e)=>{
    ...
    return(
      ...
      <Form.Group className="mb-3" controlId="formBasicCategory">
        ...
        <Form.Control name="title" value={quizEditData.title} type="text" placeholder="категория" onChange={handleChange} />
      </Form.Group>

      <Form.Group className="mb-3" controlId="formBasicCategory">
        <Form.Label>Детали</Form.Label>
        <Form.Control name="detail" value={quizEditData.detail}  as="textarea" rows={3} placeholder="Описание" onChange={handleChange} />
      </Form.Group>
