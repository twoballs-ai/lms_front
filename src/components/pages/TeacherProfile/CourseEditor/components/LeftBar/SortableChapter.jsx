...
const SortableChapter = ({
    ...
    const [examDuration, setExamDuration] = useState(
        chapter.exam_duration || 10
    );
    const [inputTitleChapterValue, setInputTitleChapterValue] = useState(
        chapter.title || ""
    );
    const [inputDescrChapterValue, setInputDescrChapterValue] = useState(
        chapter.description || ""
    );
        ...
        try {
            ...
            const newSortIndex =
                chapter.modules.length > 0
                    ? Math.max(
                          ...chapter.modules.map((module) => module.sort_index)
                      ) + 1
                    : 0;
        ...
        <>
            ...
            >
                ...
                <TextInput
                    ...
                    onChange={handleInputDescrChapterChange}
                />
    ...
    return (
        ...
        >
            <LmsModalBase
                ...
                content={contentAddModuleToModal()}
            />
            <PopupMenu
