...
function StudentLogin() {
  ...
  const submitForm = (e) => {
    ...
    console.log(studentLoginData)
    axios
      .post(baseUrl + 'student-login', studentLoginData
  ...
  return (
    <>
      ...
      <Form.Group className="mb-3" controlId="formBasicEmail">
                    ...
                    <Form.Control value={studentLoginData.email} name="email" onChange={handleChange} type="email" placeholder="Введите ваш email" />
                  </Form.Group>
      <Form.Group className="mb-3" controlId="formBasicPassword">
                    <Form.Label>password</Form.Label>
                    <Form.Control value={studentLoginData.password} name="password" onChange={handleChange} type="password" placeholder="Введите пароль" />
                  </Form.Group>
